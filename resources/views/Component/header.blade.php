<div id="header">
		...
		<div class="header-body">
			<div class="container beta-relative">
				<div class="pull-left">
					<a href="{{ route('homepage') }}" id="logo"><img src="{{ asset('source/assets/dest/images/logo-cake.png')}}" width="200px" alt=""></a>
				</div>
				<div class="pull-right beta-components space-left ov">
					<div class="space10">&nbsp;</div>
					<div class="beta-comp">
						<form role="search" method="get" id="searchform" action="/">
					        <input type="search" value="" name="search" id="search" placeholder="Nhập từ khóa..." />
						...
						<li><a href="#">Sản phẩm</a>
							<ul class="sub-menu">
                                @foreach($loai_sp as $type)
                                    <li><a href="/homepage/type_product/{{$type->id}}">{{ $type->name}}</a></li>
                                @endforeach
							</ul>
						</li>
